...
map('n', leader .. 'ab', ":lua require('config.telescope').current_buffer_fuzzy_find()<CR>", { noremap = true })
map('n', leader .. 'ag', ":lua require('config.telescope').live_grep()<CR>", { noremap = true })
map('n', leader .. 'ah', ":lua require('telescope.builtin').help_tags()<CR>", { noremap = true })
map('n', leader .. 'ak', ":lua require('telescope.builtin').keymaps()<CR>", { noremap = true })
map("n", leader .. "am", ":lua require('telescope.builtin').marks()<CR>")
map('n', leader .. 'ao', ":lua require('config.telescope').find_files()<CR>", { noremap = true })
map('n', leader .. 'aq', ":lua require('config.telescope').find_files_quickly()<CR>", { noremap = true })
map('n', leader .. 'as', ":lua require('telescope.builtin').grep_string()<CR>", { noremap = true })
map('n', leader .. 'at', ":lua require('telescope.builtin').tags()<CR>", { noremap = true })
map("n", leader .. "af", ":Telescope file_browser<CR>", { noremap = true })
